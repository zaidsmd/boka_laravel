...
var Container = function (_Node) {
     ...
     * PostCSS will adjust the current index.blade.php to match the mutations.
     *
     * @param {childIterator} callback - iterator receives each node and index.blade.php
     *
     * @return {false|undefined} returns `false` if iteration was broke
     *
     * @example
     * const root = postcss.parse('a { color: black; z-index.blade.php: 1 }');
     * const rule = root.first;
     *
     * for ( let decl of rule.nodes ) {
     *     decl.cloneBefore({ prop: '-webkit-' + decl.prop });
     *     // Cycle will be infinite, because cloneBefore moves the current node
     *     // to the next index.blade.php
     * }
     *
     * rule.each(decl => {
     *     decl.cloneBefore({ prop: '-webkit-' + decl.prop });
     *     // Will be executed only for color and z-index.blade.php
     * });
     */
     ...
     *
     * root.append('a {}');
     * root.first.append('color: black; z-index.blade.php: 1');
     */
     ...
     *
     * @param {Node|number} exist             - child or child’s index.blade.php.
     ...
     *
     * @param {Node|number} child - child or child’s index.blade.php
     *
     * @return {Node} this node for methods chain
     *
     * @example
    ...
    /**
     * Returns a `child`’s index.blade.php within the {@link Container#nodes} array.
     *
     * @param {Node} child - child of the current container.
     *
     * @return {number} child index.blade.php
     *
     * @example
     * rule.index.blade.php( rule.nodes[2] ) //=> 2
     */
 ...
 * @param {number} index.blade.php - child index.blade.php
