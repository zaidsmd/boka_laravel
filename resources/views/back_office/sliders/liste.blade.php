...
{{--                                            <label for="image" class="form-label">أضف صورة</label>--}}
                                            <input lang="ar" type="file" id="image" name="image[]" class="form-control" multiple accept="image/*">
                    ...
                    reader.onload = function(event) {
                        ...
                        img.onload = function() {
                            ...
                            if (width !== requiredWidth || height !== requiredHeight || Math.abs(aspectRatio - requiredAspectRatio) > 0.01) {
                                ...
                                // formText.textContent = `الصورة "${file.name}" لا تتطابق مع الأبعاد أو نسبة العرض إلى الارتفاع المطلوبة.`;
