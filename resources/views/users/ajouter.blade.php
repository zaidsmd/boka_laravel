                    ...
                    <form id="articles-form" enctype="multipart/form-data" action="{{route('utilisateurs.sauvegarder')}}"
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <input id="name-input" type="text" class="form-control @error('i_nom')  is-invalid @enderror " required
                            ...
                            <div class="col-4">
                                ...
                                <input type="email" id="email-input" class="form-control @error('i_email') is-invalid @enderror " required
                            ...
                            <div class="col-4">
                                ...
                                <div class="input-group">
                                    <input type="password" id="password-input"
                                           class="form-control @error('i_password') is-invalid @enderror " required
