...
return [
    ...
    'articles' => [
        ...
        'short_desc' => 'وصف قصير',
        'description' => 'الوصف',
        'description_placeholder' => 'اكتب وصفك هنا...',
        'image' => 'صورة',
        'images' => 'صور',
        'price' => 'سعر',
        'price_label' => 'سعر',
        'reduit_price' => 'السعر المخفض',
        'sale_price' => 'سعر البيع',
        'quantity' => 'الكمية',
        'add_family' => 'إضافة عائلة',
        'name' => 'اسم',
        'enter_name' => 'يرجى إدخال اسم أولاً',
        'color' => 'لون',
        'active' => 'نشط',
        'yes' => 'نعم',
        'no' => 'لا',
        'close' => 'إغلاق',
        'drop_file' => 'اسحب وأسقط ملف هنا أو انقر',
        'replace_file' => 'اسحب وأسقط ملف أو انقر للتبديل',
        'remove' => 'إزالة',
        'error' => 'آسف، الملف كبير جدًا',
    ],
